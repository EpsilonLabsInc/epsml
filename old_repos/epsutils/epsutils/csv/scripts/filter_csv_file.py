...
def main(args):
    ...
    print("Unique values in the column for filtering:")
    print(values)
...
if __name__ == "__main__":
    INPUT_CSV_FILE = "/mnt/training/splits/gradient_batches_1-5_segmed_batches_1-4_simonmed_batches_1-10_reports_with_labels_with_all_extremity_segments_train.csv"
    OUTPUT_CSV_FILE = "/mnt/training/splits/gradient_batches_1-5_segmed_batches_1-4_simonmed_batches_1-10_reports_with_labels_with_all_extremity_segments_filtered_train.csv"
