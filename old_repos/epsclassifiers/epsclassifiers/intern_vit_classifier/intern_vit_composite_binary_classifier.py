...
if __name__ == "__main__":
    ...
    GROUPED_BINARY_CLASSIFIER_CHECKPOINTS = {
        "chest": {
            "num_multi_images": 2,
            "checkpoints": [
                # TODO: update and add remaining checkpoints.
                {"name": "consolidation", "path": "/mnt/training/classifier/old/consolidation/binary_consolidation_checkpoint.pt"},
                {"name": "edema", "path": "/mnt/training/classifier/old/edema/binary_edema_checkpoint.pt"},
                {"name": "airspace opacity", "path": "/mnt/training/classifier/old/airspace_opacity/binary_airspace_opacity_checkpoint.pt"}
            ]
        },
        "head": {
            "num_multi_images": 1,
