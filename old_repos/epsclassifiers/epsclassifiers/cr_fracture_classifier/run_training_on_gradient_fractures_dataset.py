...
from epsclassifiers.cr_fracture_classifier import CrFractureClassifier
from epsdatasets.helpers.gradient_fractures.gradient_fractures_dataset_helper import GradientFracturesDatasetHelper
...
if __name__ == "__main__":
    ...
    # Gradient fractures dataset helper.
    gcs_chest_images_file = "gs://gradient-crs/archive/training/chest/chest_files_gradient_all_3_batches.csv"
    gcs_fractures_file = "gs://gradient-crs/archive/training/individual-labels/fracture/gradient-crs-22JUL2024-chest-images-with-fracture-recent-label-training.jsonl"
    ...
    dataset_helper = GradientFracturesDatasetHelper(gcs_chest_images_file=gcs_chest_images_file,
