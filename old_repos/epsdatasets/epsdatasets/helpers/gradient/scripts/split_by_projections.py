...
def main():
    ...
    frontal_projections.to_csv(FRONTAL_OUTPUT_FILE, index=False)
    lateral_projections.to_csv(LATERAL_OUTPUT_FILE, index=False)
    other_projections.to_csv(OTHER_OUTPUT_FILE, index=False)
