...
if __name__ == "__main__":
    DATASETS_INFO = [
        ...
        },
        {
            ...
            "file_name": "/mnt/all-data/reports/segmed/batch2/segmed_batch_2_final.csv",
        ...
        },
        {
            ...
            "file_name": "/mnt/all-data/reports/segmed/batch3/segmed_batch_3_final.csv",
        ...
        },
        {
            ...
            "file_name": "/mnt/all-data/reports/segmed/batch4/segmed_batch_4_final.csv",
        ...
        },
        {
            ...
            "file_name": "/mnt/all-data/reports/segmed/batch5/segmed_batch_5_final.csv",
        ...
        },
        {
            ...
            "file_name": "/mnt/all-data/reports/segmed/batch6/segmed_batch_6_final.csv",
        ...
        },
        {
            ...
            "file_name": "/mnt/all-data/reports/segmed/batch7/segmed_batch_7_final.csv",
        ...
        },
        {
            ...
            "file_name": "/mnt/all-data/reports/segmed/batch8/segmed_batch_8_final.csv",
        ...
        },
        {
            ...
            "file_name": "/mnt/all-data/reports/segmed/batch9/segmed_batch_9_final.csv",
        ...
        },
        {
            ...
            "file_name": "/mnt/all-data/reports/simonmed/batch2/simonmed_batch_2_final.csv",
            "images_base_path": "simonmed",
            "report_text_column": "cleaned_report_text",
            "labels_column": "labels",
            "image_paths_column": "filtered_image_paths"
        },
        {
            ...
            "file_name": "/mnt/all-data/reports/simonmed/batch3/simonmed_batch_3_final.csv",
            "images_base_path": "simonmed",
            "report_text_column": "cleaned_report_text",
            "labels_column": "labels",
            "image_paths_column": "filtered_image_paths"
        },
        {
            ...
            "file_name": "/mnt/all-data/reports/simonmed/batch4/simonmed_batch_4_final.csv",
            "images_base_path": "simonmed",
            "report_text_column": "cleaned_report_text",
            "labels_column": "labels",
            "image_paths_column": "filtered_image_paths"
        },
        {
            ...
            "file_name": "/mnt/all-data/reports/simonmed/batch5/simonmed_batch_5_final.csv",
            "images_base_path": "simonmed",
            "report_text_column": "cleaned_report_text",
            "labels_column": "labels",
            "image_paths_column": "filtered_image_paths"
        },
        {
            ...
            "file_name": "/mnt/all-data/reports/simonmed/batch6/simonmed_batch_6_final.csv",
            "images_base_path": "simonmed",
            "report_text_column": "cleaned_report_text",
            "labels_column": "labels",
            "image_paths_column": "filtered_image_paths"
        },
        {
            ...
            "file_name": "/mnt/all-data/reports/simonmed/batch7/simonmed_batch_7_final.csv",
            "images_base_path": "simonmed",
            "report_text_column": "cleaned_report_text",
            "labels_column": "labels",
            "image_paths_column": "filtered_image_paths"
        },
        {
            ...
            "file_name": "/mnt/all-data/reports/simonmed/batch8/simonmed_batch_8_final.csv",
            "images_base_path": "simonmed",
            "report_text_column": "cleaned_report_text",
            "labels_column": "labels",
            "image_paths_column": "filtered_image_paths"
        },
        {
            ...
            "file_name": "/mnt/all-data/reports/simonmed/batch9/simonmed_batch_9_final.csv",
            "images_base_path": "simonmed",
            "report_text_column": "cleaned_report_text",
            "labels_column": "labels",
            "image_paths_column": "filtered_image_paths"
        },
        {
            ...
            "file_name": "/mnt/all-data/reports/simonmed/batch10/simonmed_batch_10_final.csv",
            "images_base_path": "simonmed",
            "report_text_column": "cleaned_report_text",
            "labels_column": "labels",
            "image_paths_column": "filtered_image_paths"
